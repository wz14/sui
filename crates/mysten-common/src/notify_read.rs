...
/// Basically a pub/sub implementation that allows entities to subscribe by a specific id to get
/// notified once a value becomes available for the respective id. The implementation is cancel
/// safe and offers a helper counter that measures the number of pending subscribers.
#[derive(Default)]
...
#[cfg(test)]
mod tests {
    use crate::notify_read::NotifyRead;
